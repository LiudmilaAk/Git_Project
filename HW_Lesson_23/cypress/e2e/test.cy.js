...
describe("Tests to check Home Page of Cypress", () => {
  beforeEach(() => {
    homePage.navigate("https://www.cypress.io/");
  });

  it("To check navigation to the main page after clicking the logo", () => {
    homePage.elements.logo().click();
    cy.location("pathname").should("eq", "/");
  });

  it("To check the presence and correctness of navbar links", () => {
  ...
  it("To check that error message appears when User registers with the email which is already taken", () => {
  ...
  it("To check the change the currency of the card", () => {
    const currency = "RUB";
